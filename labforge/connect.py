"""Native cognis-connect emit for labforge — forward findings to any platform.

Maps labforge's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    labforge ... --format json | labforge-emit --to stix
    labforge-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
